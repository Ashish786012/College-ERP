...
class StudentForm(CustomUserForm):
    roll_no = forms.IntegerField(required=True, label="Roll Number")  # Add roll_no field
    ...
    class Meta(CustomUserForm.Meta):
        model = Student
        fields = CustomUserForm.Meta.fields + ['course', 'session', 'roll_no']  # Include roll_no
...
class StudentEditForm(CustomUserForm):
    ...
    class Meta(CustomUserForm.Meta):
        model = Student
        fields = CustomUserForm.Meta.fields + ['roll_no']  # Include roll_no
