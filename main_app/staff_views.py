...
def get_student_attendance(request):
    ...
    try:
        ...
        for attendance in attendance_data:
            student = attendance.student  # Reference to the student associated with attendance
            data = {
                "id": student.admin.id,
                "roll_no": student.roll_no,  # Fetch roll_no directly
                "name": f"{student.admin.last_name} {student.admin.first_name}",
                "status": "Present" if attendance.status else "Absent"
            }
            student_data.append(data)
        
        # Log the data in the console for inspection
        print("Student Data:", student_data)
        
        return JsonResponse(student_data, safe=False)
    
    except Exception as e:
        # Return error information in JSON format to help diagnose the problem
